...
class Oscilloscope(Instrument):
    def __init__(self, *args, **kwargs):
        ...
        self._mapChanShort = {"off": "OFF", "ch1": "CH1", "ch2": "CH2", "ch3": "CH3", "ch4": "CH4", "math": "MATH"}
        self._mapTrigMode = {"edge": "EDGE"}
        self._mapChannels = {"ch1": "CHAN1", "ch2": "CHAN2", "ch3": "CHAN3", "ch4": "CHAN4", "math": "MATH"}
        self._mapSlope = {"pos": "POS", "neg": "NEG"}

        self._mapTrigSweep = {"auto": "AUTO", "norm": "NORM", "single": "SING"}
